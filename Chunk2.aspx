<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Chunk2.aspx.cs" Inherits="Chunk2" %>
       ...
       <div id="main" class="span9" >
            ...
            <div class="row" align="center">
             ...
             <div class="mb-3" align="center">
               <div class="heading-title" style="font-size: xx-large">Log In</div>
              </div>
              <br />
                 <div class="mb-3">
            <asp:TextBox runat="server" ID="user1"
                CssClass="form-control" placeholder="User Name" Width="1000px" 
                         Font-Size="X-Large" />
            </div>
            <br />
            <div class="mb-3">
            <asp:TextBox runat="server" ID="pass1"
                CssClass="form-control" placeholder="Password" TextMode="Password" 
                    Width="1000px" Font-Size="X-Large" />
            </div>
            <br />
            <asp:Button class="btn btn-primary btn-lg btn-block" runat="server" id="Button2" 
                 Text="Sign In" OnClick="signup_Click" Font-Size="X-Large" Width="200px" />
            <br></br>
            </form>
              </div><!-- theme-img -->
