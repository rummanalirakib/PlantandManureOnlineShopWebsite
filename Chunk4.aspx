<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Chunk4.aspx.cs" Inherits="Chunk4" %>
...
<div class="content">
      ...
      <ul>
      <li>
        <h2 style="font-size: xx-large">Flower Tree</h2>
     </li>
     <li>
        <asp:Label ID="add" runat="server" Width="160px" Font-Size="X-Large" 
                  ForeColor="Black" Text="ADDTOCART"></asp:Label>
            <asp:Label ID="addsomething2" runat="server" Width="50px" Font-Bold="True" 
      ...
      <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
          ...
          SelectCommand="SELECT * FROM [product1]"></asp:SqlDataSource>
                  ...
                  <tr>
                      <td align="center">
                          <asp:ImageButton ID="ImageButton1" runat="server" CommandName="addtocart" 
                              Height="50px" ImageUrl="~/images/addtocart.png" Width="250px" 
