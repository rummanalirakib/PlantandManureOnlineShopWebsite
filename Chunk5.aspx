<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Chunk5.aspx.cs" Inherits="Chunk5" %>
...
<div class="content">
      ...
      <ul>
      <li>
        <h2 style="font-size: xx-large">Manure</h2>
     </li>
     <li>
        <asp:Label ID="add" runat="server" Width="160px" Font-Size="X-Large" 
                  ForeColor="Black" Text="ADDTOCART"></asp:Label>
            <asp:Label ID="addsomething3" runat="server" Width="50px" Font-Bold="True" 
      ...
      <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
          ...
          SelectCommand="SELECT * FROM [product2]"></asp:SqlDataSource>
                  ...
                  <tr>
                      <td align="center">
                          <asp:ImageButton ID="ImageButton1" runat="server" CommandName="addtocart" 
                              ImageUrl="~/images/addtocart.png" Width="250px" 
                              CommandArgument='<%# Eval("ProductId") %>' Height="50px" />
                      </td>
                  </tr>
              </table>
          </ItemTemplate>
